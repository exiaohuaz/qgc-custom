...
MissionItem::MissionItem(QObject* parent)
    ...
    , _param8Fact                   (0, "Command:",                     FactMetaData::valueTypeString)
{
...
void MissionItem::save(QJsonObject& json) const
{
    ...
    QJsonArray rgParams =  { param1(), param2(), param3(), param4(), param5(), param6(), param7(), param8() };
...
bool MissionItem::_convertJsonV2ToV3(QJsonObject& json, QString& errorString)
{
    ...
    // rgParam.append(coordinate.command());
