...
void SimpleMissionItem::_connectSignals(void)
{
    ...
    connect(&_commandtextFact,                      &Fact::valueChanged,                        this, &SimpleMissionItem::_commandtextChanged);
...
void SimpleMissionItem::_commandtextChanged(void)
{
    _missionItem._param8Fact.setRawValue(_commandtextFact.rawValue());
}
